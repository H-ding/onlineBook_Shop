...
<body>
	<div class="main">
		...
		<div id="MyMain">
		    ...
		    <c:forEach var="stu" items="${typelist}">
  			
  			<div class="Book001">
  				
  				<img height="70%" width="100%" alt="图片" src="files/${stu.bpicture}">
  				
  				<p >书名:${stu.bname} &nbsp;&nbsp;&nbsp; 作者:${stu.bauthor}</p>
  				<h4>价格:${stu.bprice}<h4>
  			
  			 <a href="Buyer_CheckBookAction?BId=${stu.BId}">查看详情</a>
  			 <a href="Buyer_AddCollectionAction?bid=${stu.BId}">添加收藏夹</a>	
  			</div>	
  			</c:forEach>
			</div>
		</div>

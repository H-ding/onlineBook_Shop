			...
			<div align="right">
				...
				<div class="Book001">
					<img height="200x" width="100%" alt="图片"
						src="files/1.jpg">
					<p align="center">
						书名:明朝那些事 <br> 作者:当年明月 <br> 价格:179
					</p>
					<a href="Buyer_CheckBookAction?BId=1" style="float:left;">查看详情</a>
					<a href="Buyer_AddCollectionAction?bid=1"
						style="float:right;">添加收藏夹</a>
				</div>
				<div class="Book001">
					<img height="200px" width="100%" alt="图片"
						src="files/10.jpg">
					<p align="center">
						书名:你的孤独，虽败犹荣<br> 作者:刘同 <br> 价格:23
					</p>
					<a href="Buyer_CheckBookAction?BId=10">查看详情</a> <a
						href="Buyer_AddCollectionAction?bid=10"
						style="float:right;">添加收藏夹</a>
				</div>
				<div class="Book001">
					<img height="200px" width="100%" alt="图片"
						src="files/8.jpg">
					<p align="center">
						书名:三国演义 <br> 作者:罗贯中 <br> 价格:238
					</p>
					<a href="Buyer_CheckBookAction?BId=8">查看详情</a> <a
						href="Buyer_AddCollectionAction?bid=8"
						style="float:right;">添加收藏夹</a>
				</div>
				<div class="Book001">
					<img height="200px" width="100%" alt="图片"
						src="files/13.jpg">
					<p align="center">
						书名:科学大众 <br> 作者:周坤 <br> 价格:48
					</p>
					<a href="Buyer_CheckBookAction?BId=13">查看详情</a> <a
						href="Buyer_AddCollectionAction?bid=13"
						style="float:right;">添加收藏夹</a>
				</div>
				<div class="Book001">
					<img height="200px" width="100%" alt="图片"
						src="files/15.jpg">
					<p align="center">
						书名:海路天空惯性世界 <br> 作者:温晏殊 <br> 价格:48
					</p>
					<a href="Buyer_CheckBookAction?BId=15">查看详情</a> <a
						href="Buyer_AddCollectionAction?bid=15"
						style="float:right;">添加收藏夹</a>
				</div>
				<div class="Book001">
					<img height="200px" width="100%" alt="图片"
						src="files/25.jpg">
					<p align="center">
						书名:时间简史 <br> 作者:白虹 <br> 价格:55
					</p>
					<a href="Buyer_CheckBookAction?BId=25">查看详情</a> <a
						href="Buyer_AddCollectionAction?bid=25"
						style="float:right;">添加收藏夹</a>
				</div>
				<div class="Book001">
					<img height="200px" width="100%" alt="图片"
						src="files/4.jpg">
					<p align="center">
						书名:中国通史 <br> 作者:萧枫 <br> 价格:198
					</p>
					<a href="Buyer_CheckBookAction?BId=4">查看详情</a> <a
						href="Buyer_AddCollectionAction?bid=4"
						style="float:right;">添加收藏夹</a>
				</div>
				<div class="Book001">
					<img height="200px" width="100%" alt="图片"
						src="files/22.jpg">
					<p align="center">
						书名:世界未解之谜 <br> 作者:刘益宏 <br> 价格:50
					</p>
					<a href="Buyer_CheckBookAction?BId=22">查看详情</a> <a
						href="Buyer_AddCollectionAction?bid=22"
						style="float:right;">添加收藏夹</a>
				</div>
			</div>
		</div>

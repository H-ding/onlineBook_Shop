		...
		<main class="main">
			<center>
				<div>
					...
					恭喜您，当前网站注册的买家有：<%=request.getSession().getAttribute("userList")%><span><a
						href="TManagerCheckBuyList?pageNo=1">查看买家列表</a></span><br>
					恭喜您，当前网站注册的卖家有：<%=request.getSession().getAttribute("salerList")%><span><a
						href="TManagerCheckSalerList?pageNo=1">查看卖家列表</a></span><br>

...
<body
	...
	<div class="app-body">
		...
		<main class="main">
			<center>
				<a href="TManagerCheckBuyList?pageNo=1">首页</a>
				<c:if test="${pageNo>1}">
					<a href="TManagerCheckBuyList?pageNo=${pageNo-1}">上一页</a>
				</c:if>

				<a href="TManagerCheckBuyList?pageNo=${pageNo+1}">下一页</a>
				...
				<table border="1" width="100%">
					...
					<c:forEach var="stu" items="${managerBuyerList}">
						<tr>

							<th><c:out value="${stu.UId}"></c:out></th>
							<th><c:out value="${stu.uname}"></c:out></th>
							<th><c:out value="${stu.tel}"></c:out></th>
							<th><c:out value="${stu.uaddresss}"></c:out></th>
							<th><c:out value="${stu.vip}"></c:out></th>
						</tr>
					</c:forEach>
				</table>
			</center>

...
<body
	...
	<div class="app-body">
		...
		<main class="main">
			...
			<c:forEach var="stu" items="${orderTableList}">
				<form
					action="TUserEVSubmit?OId=${stu.OId}&uname=${stu.uname}&sname=${stu.sname}&BId=${stu.TBook.BId}"
					method="post">
					<table width="100%">
						...
						<tr>
							<th><span>产品质量：<input checked="checked" type="radio"
									name="quality" value="好评">好评
							</span> <span><input type="radio" name="quality" value="中评">中评
							</span> <span><input type="radio" name="quality" value="差评">差评
							</span></th>
						</tr>
						<tr>
							<th><span>配送速度：<input checked="checked" type="radio"
									name="dispatching" value="好评">好评
							</span> <span><input type="radio" name="dispatching" value="中评">中评
							</span> <span><input type="radio" name="dispatching" value="差评">差评
							</span></th>
						</tr>
						<tr>
							<th><span>服务态度：<input checked="checked" type="radio"
									name="diservice" value="好评">好评
							</span> <span><input type="radio" name="diservice" value="中评">中评
							</span> <span><input type="radio" name="diservice" value="差评">差评
							</span></th>
						</tr>
						<tr>
							<th>买家评价: <textarea rows="5" cols="30" name="uevaluate"></textarea>
							</th>
						</tr>
						<tr>

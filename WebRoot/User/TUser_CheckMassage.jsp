	...
	<div class="app-body">
		...
		<main class="main">
			<%
				...
				String password = tseller.getPasswd();
			%>
			<div class="container">
					...
					<div class="col-md-6">
						<div class="card mx-2">
							<div class="card-block p-2">
								<h1>MyMassage</h1>
								<p class="text-muted">Check your Massage</p>
								...
								<div class="input-group mb-1">
									<span class="input-group-addon"><i class="icon-user"></i>
										...
										placeholder="tel" value="<%=tel%>" readonly="readonly">
								</div>
								<a href="TUerBackMainPage"><button type="button"
										class="btn btn-block btn-success">Return MainPage</button></a>
							</div>

...
<body
	...
	<div class="app-body">
				...
				<ul class="nav">
					...
					<li class="nav-item"><a class="nav-link"
						href="DeleteBookListAction?pageNo=1"><i
							class="icon-calculator"></i>下架我的图书 <span class="badge badge-info"></span></a>
					</li>
					<li class="nav-item"><a class="nav-link"
		...
		<main class="main">
			<center>
				<a href="CheckSaleAmount?pageNo=1">首页</a>
				<c:if test="${pageNo>1}">
					<a href="CheckSaleAmount?pageNo=${pageNo-1}">上一页</a>
				</c:if>

				<a href="CheckSaleAmount?pageNo=${pageNo+1}">下一页</a>
			</center>

			<c:forEach var="stu" items="${Check_Sale_list}">
				<table width="100%">
					<tr>
			...
			<b><div align="right">
					当前页的销售额为：<%=request.getSession().getAttribute("CurrentCount")%></div></b>
		</main>

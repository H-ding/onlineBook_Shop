<%@ page language="java" import="java.util.*,com.itheima.domain.TSeller"
	pageEncoding="UTF-8"%>
...
<%
	String username = (String) request.getSession().getAttribute(
			"username");
	TSeller tseller = (TSeller) request.getSession().getAttribute(
			"tseller");
	String Introduce = tseller.getSintroduce();
	String Address = tseller.getSaddress();
%>
...
<body
	...
	<div class="app-body">
		...
		<!-- Main content -->
		<main class="main">
			<form action="UpdataMassage" method="post">
				<div class="container">
								...
								<div class="card-block p-2">
									...
									<div class="input-group mb-1">
										...
										<input type="text" name="Introduce" placeholder="Introduce"
											class="form-control" rows="10" cols="35"
											value="<%=Introduce%>">
										</textarea>
									</div>
									...
									<div class="input-group mb-1">
										<span class="input-group-addon"><i class="icon-user"></i>
										</span> <input type="text" name="SAddress" class="form-control"
											placeholder="SAddress" value="<%=Address%>">
									</div>

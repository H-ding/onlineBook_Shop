...
<body
	...
	<div class="app-body">
		...
		<main class="main">
			<center>
				<a href="CheckBookAction?pageNo=1">首页</a>
				<c:if test="${pageNo>1}">
					<a href="CheckBookAction?pageNo=${pageNo-1}">上一页</a>
				</c:if>
				<c:if test="${pageNo==1}">
					<a href="CheckBookAction?pageNo=${pageNo+1}">下一页</a>
				</c:if>
				<table width="80%" border="1" height="56">
					...
					<c:forEach var="stu" items="${booklist}">
						<tr>
							...
							<td><a href="UpdateBookAction?BId=${stu.BId}">修改信息</a></td>
						</tr>
					</c:forEach>
				</table>
			</center>

...
<body
			...
			<li class="nav-item dropdown"><a
				...
				<div class="dropdown-menu dropdown-menu-right">
					...
					<li class="nav-item hidden-md-down"><a
						class="nav-link navbar-toggler aside-menu-toggler" href="#">☰</a>
					</li>
		</ul>
	</header>
	...
	<div class="app-body">
		...
		<main class="main">
			<center>
				<a href="DeleteBookListAction?pageNo=1">首页</a>
				<c:if test="${pageNo>1}">
					<a href="DeleteBookListAction?pageNo=${pageNo-1}">上一页</a>
				</c:if>

				<a href="DeleteBookListAction?pageNo=${pageNo+1}">下一页</a>
				...
				<table width="80%" border="1" height="56">
					...
					<c:forEach var="stu" items="${queryList}">
						<tr>
							...
							<td><c:out value="${stu.bintroduce}" /></td>
							<td><a href="DeleteBookAction?BId=${stu.BId}">下架该图书</a></td>
						</tr>
					</c:forEach>
				</table>
			</center>
